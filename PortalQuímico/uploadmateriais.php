...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (empty($_POST) && empty($_FILES) && $_SERVER['CONTENT_LENGTH'] > 0) {
        $erro = "Arquivo muito grande! O servidor não aceita arquivos acima do limite configurado (geralmente ~40 MB). Escolha um arquivo menor que 30 MB.";
    }
}
    ...
    <div class="container">
        <div class="upload-box">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="input-field">
                    <input type="text" name="descricao" id="descricao" class="materialize-textarea"
            ...
            <div class="center" style="margin-top:30px;">
                <a href="materiaisadm.php" class="blue-text">
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (fileInput && fileInput.files.length > 0) {
            ...
            if (fileSize > maxSize) {
                e.preventDefault();
                M.toast({
                    html: 'Erro: Arquivo muito grande! Máximo permitido: 30 MB.',
                    classes: 'red rounded',
                    displayLength: 6000
                });
            }
